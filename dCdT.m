...
%%
% Fluid total concentration C (kmol/m3)
[Vm,~]=PRSV(T,P,y);
C=(1/Vm);

%%
% Derivative of the total concentration C with respect to the temperature
% dCdT (kmol/m3/K)

dC=(dX*(C^2/(1+2*b*C-C^2*b^2))-(C^2*R/(C-C^2*b)))/((2*C*R*T/(C-C^2*b))-...
    (C^2*R*T/((C-C^2*b)^2))+2*b*C*(C^2*R*T/((C-C^2*b)^2))-...
    X*(2*C/(1+2*b*C-C^2*b^2))+X*(2*b*C^2/((1+2*b*C-C^2*b^2)^2))-...
    X*2*C*b^2*C^2/((1+2*b*C-C^2*b^2)^2));
end
